...
"""
    ...
    def generate_deep_research_prompt(
        ...
        report_format="apa",
        tone=None,
        total_words=18000,  # Default to 18,000 words for deep research (targeting 16-20 pages at ~500 words/page)
...
Write a comprehensive, in-depth research report answering the query: "{question}"
...
6. Have a minimum length of {total_words} words (targeting 16-20 pages of comprehensive content, approximately 500 words per page)
...
9. Be EXTENSIVE and DETAILED - cover all aspects of the topic thoroughly
10. Include multiple sections with in-depth analysis of each aspect
...
- Include relevant statistics, data, and concrete examples throughout
- Provide detailed explanations and analysis, not just summaries
- Expand on each point with comprehensive detail and context
- You MUST determine your own concrete and valid opinion based on the given information. Do NOT defer to general and meaningless conclusions.
- You MUST prioritize the relevance, reliability, and significance of the sources you use. Choose trusted sources over less reliable ones.
- You must also prioritize new articles over older articles if the source can be trusted.
- Use in-text citation references in {report_format} format and make it with markdown hyperlink placed at the end of the sentence or paragraph that references them like this: ([in-text citation](url)).
- {tone_prompt}
- Write in {language}
- IMPORTANT: This is a DEEP RESEARCH report - it must be comprehensive, extensive, and detailed. Aim for at least {total_words} words (16-20 pages) with thorough coverage of all relevant aspects.

{reference_prompt}

Please write a thorough, extensive, and well-researched report that synthesizes all the gathered information into a cohesive, comprehensive whole. The report should be detailed enough to serve as a complete reference on the topic.

CRITICAL REQUIREMENTS FOR DEEP RESEARCH (16-20 PAGES):
- The report MUST be at least {total_words} words long (targeting 16-20 pages, approximately 500 words per page)
- CRITICAL: You MUST use your full token budget - continue writing until you have generated at least {total_words} words. DO NOT stop early.
- CRITICAL: Keep writing until you have used most of your available token budget - do not stop prematurely
- DO NOT summarize - provide detailed, in-depth analysis of every aspect
- Expand on each point with extensive detail, examples, and explanations
- Include comprehensive sections covering all facets of the topic
- Use the full context provided - do not skip or summarize information
- Write extensively on each section to reach the {total_words} word minimum
- The report should be comprehensive enough to serve as a complete reference document (16-20 pages)
- Each major section should be 2-3 pages long with detailed analysis
