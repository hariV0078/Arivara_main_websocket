def get_retriever(retriever: str):
    ...
    match retriever:
        case "google":
            from arivara_researcher.retrievers import GoogleSearch

            return GoogleSearch
        case "searx":
            from arivara_researcher.retrievers import SearxSearch

            return SearxSearch
        case "searchapi":
            from arivara_researcher.retrievers import SearchApiSearch

            return SearchApiSearch
        case "serpapi":
            from arivara_researcher.retrievers import SerpApiSearch

            return SerpApiSearch
        case "serper":
            from arivara_researcher.retrievers import SerperSearch

            return SerperSearch
        case "duckduckgo":
            from arivara_researcher.retrievers import Duckduckgo

            return Duckduckgo
        case "bing":
            from arivara_researcher.retrievers import BingSearch

            return BingSearch
        case "arxiv":
            from arivara_researcher.retrievers import ArxivSearch

            return ArxivSearch
        case "tavily":
            from arivara_researcher.retrievers import TavilySearch

            return TavilySearch
        case "exa":
            from arivara_researcher.retrievers import ExaSearch

            return ExaSearch
        case "semantic_scholar":
            from arivara_researcher.retrievers import SemanticScholarSearch

            return SemanticScholarSearch
        case "pubmed_central":
            from arivara_researcher.retrievers import PubMedCentralSearch

            return PubMedCentralSearch
        case "custom":
            from arivara_researcher.retrievers import CustomRetriever

            return CustomRetriever
        case "mcp":
            from arivara_researcher.retrievers import MCPRetriever
