...
const FeatureList = [
  {
    title: 'Arivara Researcher',
    Svg: require('../../static/img/gptr-logo.png').default,
    docLink: './docs/gpt-researcher/getting-started/getting-started',
    description: (
      <>
        Arivara Researcher is an open source autonomous agent designed for comprehensive online research on a variety of tasks.
      </>
    ),
  },
  /*{
  ...
  },
  {
    ...
    description: (
      <>
          Check out Arivara Researcher in action across multiple frameworks and use cases such as hybrid research and long detailed reports.
      </>
    ),
  },
];
